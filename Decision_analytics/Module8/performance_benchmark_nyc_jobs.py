...
# Define your queries
queries = [
    'SELECT * FROM public.nyc_jobs_detail;',
    'SELECT COUNT(*),Level FROM public.nyc_jobs_detail GROUP BY Level;',
    'SELECT * FROM public.nyc_jobs_detail WHERE trim(Agency) = \'HOUSING PRESERVATION & DVLPMNT\';',
    'select distinct a.* from public.nyc_jobs_detail a;' 
]
