...
#service times for arrival
    def arrival(self, patient):
        ...
        lambda_arrival = 12
        service_time = np.random.exponential(1 / lambda_arrival)
...
#service times for triage
    def triage(self, patient):
        ...
        lambda_triage = 6
        service_time = np.random.exponential(1 / lambda_triage)
        yield self.env.timeout(service_time)
...
#service times for exam rooms
    def exam_room(self, patient):
        ...
        lambda_exam_room = 2
        service_time = np.random.exponential(1 / lambda_exam_room)
        yield self.env.timeout(service_time)
...
#service times for trauma rooms
    def trauma_room(self, patient):
        ...
        service_time = np.random.exponential(1 / lambda_trauma_room)
        yield self.env.timeout(service_time)
...
#service times for imaging
    def imaging(self, patient):
        ...
        imaging_lambda = 4
        service_time = np.random.exponential(1 / imaging_lambda)
        yield self.env.timeout(service_time)
...
#service times for doctor consultation
    def doctor_consultation(self, patient):
        ...
        service_time = np.random.exponential(1 / consultation_lambda)
        yield self.env.timeout(service_time)
